...
export async function verifyShowroom(env=process.env){
 ...
 try{
  ...
  for(const [route,path,key] of [['/','../public/index.html','html'],['/style.css?v=showroom-2','../public/style.css','css'],['/app.js?v=showroom-2','../public/app.js','javascript'],['/showroom.avif','../public/showroom.avif','artwork']]){
