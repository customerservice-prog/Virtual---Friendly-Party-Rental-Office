    ...
    with (OUT/'apprentice-backend.log').open('w') as log:
        ...
        try:
            ...
            with sync_playwright() as p:
                ...
                page.locator('.ap-nav [data-ap-route="cases"]').click(force=True);expect(page.locator('#apprentice-view')).to_be_visible()
                ...
                page.locator('.ap-nav [data-ap-route="phone"]').click(force=True);expect(page.locator('#ap-phone-form')).to_be_visible()
