    ...
    with (OUT/'apprentice-backend.log').open('w') as log:
        ...
        try:
            ...
            with sync_playwright() as p:
                ...
                page.locator('.ap-nav [data-ap-route="cases"]').evaluate("e=>e.click()");expect(page.locator('#apprentice-view')).to_be_visible()
                ...
                page.locator('.ap-nav [data-ap-route="phone"]').evaluate("e=>e.click()");expect(page.locator('#ap-phone-form')).to_be_visible()
